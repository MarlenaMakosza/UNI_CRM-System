Przeanalizuj pliki @backend\src\types\clients.ts @backend\src\types\index.ts @backend\src\utils\errorHandler.ts @backend\src\utils\clientValidation.ts @backend\src\mappers\clientMapper.ts @backend\src\repository\clientRepository.ts @backend\src\service\clientService.ts @backend\src\routes\clientsController.ts - sprawdź czy error handling jest odpowiednio przeprowadzony, bo coś mie nie pasuje na poziomie logicznym
